                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-between py-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-10">
                        ...
                        <button
                            ...
                            className={`${stock === 0 && 'pointer-events-none'} btn  btn-outline btn-lg border-slate-200 text-slate-600 shadow-md hover:bg-slate-50 hover:border-slate-300 normal-case flex items-center gap-2`}
                        >
