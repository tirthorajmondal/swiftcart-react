        ...
        <div className="card bg-base-100 shadow-xl border border-gray-200 overflow-hidden h-full w-full">
            ...
            <div className="card-body p-5 gap-4 grow">
                ...
                <div className="card-actions grid grid-cols-2 gap-3 mt-2">
                    <Link to={`/product/${id}`}
                        className="btn btn-outline border-gray-300 text-slate-600 rounded-lg hover:bg-gray-50 hover:border-gray-400 uppercase">
                        Details
                    </Link>
                    <button
                        onClick={() => addToCart(product)}
                        className="btn bg-primary hover:bg-[#4533d1f5] border-none rounded-lg text-white uppercase">
